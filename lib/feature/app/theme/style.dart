...
const bottomAttachColor = Color.fromRGBO(38, 54, 65, 1.0);
const webAppBarColor = Color.fromRGBO(42, 47, 50, 1);
const messageColor = Color.fromRGBO(5, 96, 98, 1);
const sendMessageColor = Color.fromRGBO(37, 45, 49 ,1);
...
const chatBarMessageColor = Color.fromRGBO(30, 36, 40, 1);
